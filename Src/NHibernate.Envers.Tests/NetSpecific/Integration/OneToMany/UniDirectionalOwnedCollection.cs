...
{
	public partial class UniDirectionalOwnedCollection : TestBase
	{
		private Guid parentId;
		private Guid child1Id;
		private Guid child2Id;

		public UniDirectionalOwnedCollection(AuditStrategyForTest strategyType) : base(strategyType)
		{
		}
		...
		protected override IEnumerable<string> Mappings
		{
			get
			{
				yield return "NetSpecific.Integration.OneToMany.OwnedCollection.hbm.xml";
			}
		}
		...
		public void ChildTableShoudHaveParentId()
		{
			...
			childMapping.Table.ColumnIterator.Where(x => x.Name.Equals("parentId")).Should().Have.Count.EqualTo(1);
		}
	}
}